...
<!-- 로그인 안 된 경우 -->
<body >
&nbsp;&nbsp;&nbsp;<img src="../images/logo2.png" algin=left width=30px height=30px/>&nbsp;<a href='../main.ccc' id='logo'>CCC</a>
<div class='menu'>
...
<ul class="submenu">
 <li><a href="../not/notList.not" class="submenuLink longLink">공지사항</a></li>
</ul> 
</li>
...
<ul class="submenu">
 <li><a href="../not/notList.not" class="submenuLink longLink">공지사항</a></li>
 <li><a href="memberDetail.mem" class="submenuLink longLink">마이페이지</a></li>
